...
slug: "lc-0480-sliding-window-median-1"
summary: "Hard Mix • Level 5 • Hard — Sliding Window Median (LeetCode 480)"
...
<div class="lc-problem-header">
  <span class="lc-pill lc-pill-hard">Hard</span> <span class="lc-pill lc-pill-pattern">Hard Mix</span> <span class="lc-pill lc-pill-level">Level 5</span> <a href="https://leetcode.com/problems/sliding-window-median/" target="_blank">LeetCode 480 ↗</a>
</div>

## 📋 Đề bài

<div class="lc-description"><p>Cho mảng <code>nums</code> và cửa sổ <code>k</code>, hãy trả về trung vị mỗi cửa sổ (bản Hard Mix).</p>
