...
slug: "lc-0268-missing-number-1"
summary: "Bit Manipulation • Level 5 • Easy — Missing Number (LeetCode 268)"
...
<div class="lc-problem-header">
  <span class="lc-pill lc-pill-easy">Easy</span> <span class="lc-pill lc-pill-pattern">Bit Manipulation</span> <span class="lc-pill lc-pill-level">Level 5</span> <a href="https://leetcode.com/problems/missing-number/" target="_blank">LeetCode 268 ↗</a>
</div>

## 📋 Đề bài

<div class="lc-description"><p>Cho mảng <code>nums</code> chứa <code>n</code> số khác nhau trong <code>[0,n]</code>, hãy tìm số thiếu (bản Bit).</p>
