...
slug: "lc-1293-shortest-path-in-a-grid-with-o"
summary: "Advanced Graph • Level 4 • Hard — Shortest Path in a Grid with Obstacles Elimination (LeetCode 1293)"
...
<div class="lc-problem-header">
  <span class="lc-pill lc-pill-hard">Hard</span> <span class="lc-pill lc-pill-pattern">Advanced Graph</span> <span class="lc-pill lc-pill-level">Level 4</span> <a href="https://leetcode.com/problems/shortest-path-in-a-grid-with-obstacles-elimination/" target="_blank">LeetCode 1293 ↗</a>
</div>
