...
slug: "lc-0210-course-schedule-ii-2"
summary: "Advanced Graph • Level 4 • Medium — Course Schedule II (LeetCode 210)"
...
<div class="lc-problem-header">
  <span class="lc-pill lc-pill-medium">Medium</span> <span class="lc-pill lc-pill-pattern">Advanced Graph</span> <span class="lc-pill lc-pill-level">Level 4</span> <a href="https://leetcode.com/problems/course-schedule-ii/" target="_blank">LeetCode 210 ↗</a>
</div>

## 📋 Đề bài

<div class="lc-description"><p>Cho <code>numCourses</code> và <code>prerequisites</code>, hãy trả về thứ tự học các môn thỏa mãn điều kiện, nếu không thể trả về mảng rỗng.</p>
