...
slug: "lc-0310-minimum-height-trees-1"
summary: "Advanced Graph • Level 4 • Medium — Minimum Height Trees (LeetCode 310)"
...
<div class="lc-problem-header">
  <span class="lc-pill lc-pill-medium">Medium</span> <span class="lc-pill lc-pill-pattern">Advanced Graph</span> <span class="lc-pill lc-pill-level">Level 4</span> <a href="https://leetcode.com/problems/minimum-height-trees/" target="_blank">LeetCode 310 ↗</a>
</div>
...
<strong>Giải thích:</strong> As shown, the height of the tree is 1 when the root is the node with label 1 which is the only MHT.
</pre>
