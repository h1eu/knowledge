...
slug: "lc-0721-accounts-merge"
summary: "Graph • Level 4 • Medium — Accounts Merge (LeetCode 721)"
...
<div class="lc-problem-header">
  <span class="lc-pill lc-pill-medium">Medium</span> <span class="lc-pill lc-pill-pattern">Graph</span> <span class="lc-pill lc-pill-level">Level 4</span> <a href="https://leetcode.com/problems/accounts-merge/" target="_blank">LeetCode 721 ↗</a>
</div>

## 📋 Đề bài

<div class="lc-description"><p>Cho danh sách tài khoản với tên và email, hãy gộp các tài khoản có chung email.</p>
