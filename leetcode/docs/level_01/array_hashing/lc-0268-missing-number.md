...
slug: "lc-0268-missing-number"
summary: "Array & Hashing • Level 1 • Easy — Missing Number (LeetCode 268)"
...
<div class="lc-problem-header">
  <span class="lc-pill lc-pill-easy">Easy</span> <span class="lc-pill lc-pill-pattern">Array & Hashing</span> <span class="lc-pill lc-pill-level">Level 1</span> <a href="https://leetcode.com/problems/missing-number/" target="_blank">LeetCode 268 ↗</a>
</div>

## 📋 Đề bài

<div class="lc-description"><p>Cho mảng <code>nums</code> chứa <code>n</code> số khác nhau trong khoảng <code>[0, n]</code>, hãy trả về số duy nhất còn thiếu trong khoảng.</p>
