...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/chapter_dynamic_programming.jpg" alt="Quy hoạch động" style="max-width: 100%; height: auto; border-radius: var(--radius-md); box-shadow: var(--shadow-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/climbing_stairs_example.png" alt="Số cách để lên đến bậc thứ 3" style="max-width: 100%; height: auto; border-radius: var(--radius-md); box-shadow: var(--shadow-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/climbing_stairs_state_transfer.png" alt="Quan hệ truy hồi cho số cách đi" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/climbing_stairs_dfs_tree.png" alt="Cây đệ quy cho bài toán leo cầu thang" style="max-width: 90%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/climbing_stairs_dfs_memo_tree.png" alt="Cây đệ quy với đệ quy có nhớ" style="max-width: 90%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/climbing_stairs_dp.png" alt="Quá trình quy hoạch động cho bài toán leo cầu thang" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/min_cost_cs_example.png" alt="Chi phí nhỏ nhất để leo đến bậc thứ 3" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/min_cost_cs_dp.png" alt="Quá trình quy hoạch động cho bài toán leo cầu thang chi phí nhỏ nhất" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/climbing_stairs_constraint_example.png" alt="Số cách để leo đến bậc thứ 3 với ràng buộc" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/climbing_stairs_constraint_state_transfer.png" alt="Quan hệ truy hồi khi xét đến ràng buộc" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/min_path_sum_example.png" alt="Dữ liệu ví dụ về tổng đường đi nhỏ nhất" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/min_path_sum_solution_state_definition.png" alt="Định nghĩa trạng thái và bảng dp" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/min_path_sum_solution_state_transition.png" alt="Cấu trúc con tối ưu và phương trình chuyển trạng thái" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/min_path_sum_solution_initial_state.png" alt="Điều kiện biên và thứ tự chuyển trạng thái" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/min_path_sum_dfs.png" alt="Cây đệ quy tìm kiếm vét cạn" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/min_path_sum_dfs_mem.png" alt="Cây đệ quy đệ quy có nhớ" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div class="interactive-widget-wrapper" id="min-path-sum-steps-wrapper"><div class="slider-container"><div class="slide active"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step1.png" alt="Bước 1: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 1: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step2.png" alt="Bước 2: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 2: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step3.png" alt="Bước 3: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 3: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step4.png" alt="Bước 4: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 4: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step5.png" alt="Bước 5: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 5: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step6.png" alt="Bước 6: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 6: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step7.png" alt="Bước 7: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 7: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step8.png" alt="Bước 8: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 8: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step9.png" alt="Bước 9: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 9: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step10.png" alt="Bước 10: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 10: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step11.png" alt="Bước 11: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 11: điền bảng dp theo quy hoạch động</p></div><div class="slide"><img loading="lazy" src="dsa-assets/min_path_sum_dp_step12.png" alt="Bước 12: điền bảng dp theo quy hoạch động" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 12: điền bảng dp theo quy hoạch động</p></div><div class="slider-controls"><button onclick="prevSlide('min-path-sum-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 12</span><button onclick="nextSlide('min-path-sum-steps-wrapper')">Sau ▶</button></div></div></div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/knapsack_example.png" alt="Dữ liệu ví dụ về Cái túi 0-1" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/knapsack_dfs.png" alt="Cây đệ quy tìm kiếm vét cạn cho bài toán Cái túi 0-1" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/knapsack_dfs_mem.png" alt="Cây đệ quy đệ quy có nhớ cho bài toán Cái túi 0-1" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div class="interactive-widget-wrapper" id="knapsack-dp-steps-wrapper"><div class="slider-container"><div class="slide active"><img loading="lazy" src="dsa-assets/knapsack_dp_step1.png" alt="Bước 1: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 1: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step2.png" alt="Bước 2: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 2: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step3.png" alt="Bước 3: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 3: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step4.png" alt="Bước 4: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 4: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step5.png" alt="Bước 5: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 5: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step6.png" alt="Bước 6: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 6: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step7.png" alt="Bước 7: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 7: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step8.png" alt="Bước 8: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 8: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step9.png" alt="Bước 9: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 9: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step10.png" alt="Bước 10: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 10: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step11.png" alt="Bước 11: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 11: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step12.png" alt="Bước 12: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 12: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step13.png" alt="Bước 13: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 13: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_step14.png" alt="Bước 14: điền bảng dp 2 chiều cho Cái túi 0-1" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 14: điền bảng dp 2 chiều cho Cái túi 0-1</p></div><div class="slider-controls"><button onclick="prevSlide('knapsack-dp-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 14</span><button onclick="nextSlide('knapsack-dp-steps-wrapper')">Sau ▶</button></div></div></div>
...
<div class="interactive-widget-wrapper" id="knapsack-dp-comp-steps-wrapper"><div class="slider-container"><div class="slide active"><img loading="lazy" src="dsa-assets/knapsack_dp_comp_step1.png" alt="Bước 1: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 1: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_comp_step2.png" alt="Bước 2: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 2: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_comp_step3.png" alt="Bước 3: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 3: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_comp_step4.png" alt="Bước 4: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 4: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_comp_step5.png" alt="Bước 5: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 5: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D</p></div><div class="slide"><img loading="lazy" src="dsa-assets/knapsack_dp_comp_step6.png" alt="Bước 6: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 6: chuyển từ hàng i-1 sang hàng i, duyệt ngược mảng 1D</p></div><div class="slider-controls"><button onclick="prevSlide('knapsack-dp-comp-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 6</span><button onclick="nextSlide('knapsack-dp-comp-steps-wrapper')">Sau ▶</button></div></div></div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/unbounded_knapsack_example.png" alt="Dữ liệu ví dụ về Cái túi không giới hạn" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/coin_change_example.png" alt="Dữ liệu ví dụ về bài toán Đổi tiền" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div class="interactive-widget-wrapper" id="coin-change-dp-steps-wrapper"><div class="slider-container"><div class="slide active"><img loading="lazy" src="dsa-assets/coin_change_dp_step1.png" alt="Bước 1: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 1: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step2.png" alt="Bước 2: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 2: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step3.png" alt="Bước 3: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 3: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step4.png" alt="Bước 4: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 4: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step5.png" alt="Bước 5: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 5: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step6.png" alt="Bước 6: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 6: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step7.png" alt="Bước 7: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 7: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step8.png" alt="Bước 8: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 8: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step9.png" alt="Bước 9: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 9: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step10.png" alt="Bước 10: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 10: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step11.png" alt="Bước 11: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 11: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step12.png" alt="Bước 12: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 12: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step13.png" alt="Bước 13: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 13: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step14.png" alt="Bước 14: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 14: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slide"><img loading="lazy" src="dsa-assets/coin_change_dp_step15.png" alt="Bước 15: điền bảng dp cho bài toán Đổi tiền" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 15: điền bảng dp cho bài toán Đổi tiền</p></div><div class="slider-controls"><button onclick="prevSlide('coin-change-dp-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 15</span><button onclick="nextSlide('coin-change-dp-steps-wrapper')">Sau ▶</button></div></div></div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/coin_change_ii_example.png" alt="Dữ liệu ví dụ về bài toán Đổi tiền II" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/edit_distance_example.png" alt="Dữ liệu ví dụ về Khoảng cách chỉnh sửa" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/edit_distance_decision_tree.png" alt="Biểu diễn bài toán Khoảng cách chỉnh sửa dựa trên mô hình cây quyết định" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img loading="lazy" src="dsa-assets/edit_distance_state_transfer.png" alt="Chuyển trạng thái cho Khoảng cách chỉnh sửa" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div class="interactive-widget-wrapper" id="edit-distance-dp-steps-wrapper"><div class="slider-container"><div class="slide active"><img loading="lazy" src="dsa-assets/edit_distance_dp_step1.png" alt="Bước 1: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 1: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step2.png" alt="Bước 2: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 2: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step3.png" alt="Bước 3: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 3: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step4.png" alt="Bước 4: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 4: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step5.png" alt="Bước 5: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 5: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step6.png" alt="Bước 6: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 6: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step7.png" alt="Bước 7: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 7: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step8.png" alt="Bước 8: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 8: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step9.png" alt="Bước 9: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 9: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step10.png" alt="Bước 10: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 10: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step11.png" alt="Bước 11: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 11: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step12.png" alt="Bước 12: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 12: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step13.png" alt="Bước 13: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 13: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step14.png" alt="Bước 14: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 14: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slide"><img loading="lazy" src="dsa-assets/edit_distance_dp_step15.png" alt="Bước 15: điền bảng dp cho Khoảng cách chỉnh sửa" style="max-width:100%;height:auto;border-radius:var(--radius-md);" /><p class="slide-caption">Bước 15: điền bảng dp cho Khoảng cách chỉnh sửa</p></div><div class="slider-controls"><button onclick="prevSlide('edit-distance-dp-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 15</span><button onclick="nextSlide('edit-distance-dp-steps-wrapper')">Sau ▶</button></div></div></div>
