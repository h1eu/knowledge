...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/chapter_graph.jpg" alt="Đồ thị (Graph)" style="max-width: 100%; height: auto; border-radius: var(--radius-md); box-shadow: var(--shadow-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/linkedlist_tree_graph.png" alt="Mối quan hệ giữa danh sách liên kết, cây và đồ thị" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/directed_graph.png" alt="Đồ thị có hướng và vô hướng" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/connected_graph.png" alt="Đồ thị liên thông và không liên thông" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/weighted_graph.png" alt="Đồ thị có trọng số và không có trọng số" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/adjacency_matrix.png" alt="Biểu diễn đồ thị bằng ma trận kề" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/adjacency_list.png" alt="Biểu diễn đồ thị bằng danh sách kề" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div class="interactive-widget-wrapper" id="adj-mat-ops-steps-wrapper"><div class="slider-container"><div class="slide active"><img src="dsa-assets/adjacency_matrix_step1_initialization.png" alt="Bước 1: Khởi tạo đồ thị bằng ma trận kề" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 1: Khởi tạo đồ thị bằng ma trận kề</p></div><div class="slide"><img src="dsa-assets/adjacency_matrix_step2_add_edge.png" alt="Bước 2: Thêm cạnh" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 2: Thêm cạnh</p></div><div class="slide"><img src="dsa-assets/adjacency_matrix_step3_remove_edge.png" alt="Bước 3: Xóa cạnh" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 3: Xóa cạnh</p></div><div class="slide"><img src="dsa-assets/adjacency_matrix_step4_add_vertex.png" alt="Bước 4: Thêm đỉnh" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 4: Thêm đỉnh</p></div><div class="slide"><img src="dsa-assets/adjacency_matrix_step5_remove_vertex.png" alt="Bước 5: Xóa đỉnh" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 5: Xóa đỉnh</p></div><div class="slider-controls"><button class="slider-btn" onclick="prevSlide('adj-mat-ops-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 5</span><button class="slider-btn" onclick="nextSlide('adj-mat-ops-steps-wrapper')">Sau ▶</button></div></div></div>
...
<div class="interactive-widget-wrapper" id="adj-list-ops-steps-wrapper"><div class="slider-container"><div class="slide active"><img src="dsa-assets/adjacency_list_step1_initialization.png" alt="Bước 1: Khởi tạo đồ thị bằng danh sách kề" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 1: Khởi tạo đồ thị bằng danh sách kề</p></div><div class="slide"><img src="dsa-assets/adjacency_list_step2_add_edge.png" alt="Bước 2: Thêm cạnh" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 2: Thêm cạnh</p></div><div class="slide"><img src="dsa-assets/adjacency_list_step3_remove_edge.png" alt="Bước 3: Xóa cạnh" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 3: Xóa cạnh</p></div><div class="slide"><img src="dsa-assets/adjacency_list_step4_add_vertex.png" alt="Bước 4: Thêm đỉnh" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 4: Thêm đỉnh</p></div><div class="slide"><img src="dsa-assets/adjacency_list_step5_remove_vertex.png" alt="Bước 5: Xóa đỉnh" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 5: Xóa đỉnh</p></div><div class="slider-controls"><button class="slider-btn" onclick="prevSlide('adj-list-ops-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 5</span><button class="slider-btn" onclick="nextSlide('adj-list-ops-steps-wrapper')">Sau ▶</button></div></div></div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/graph_bfs.png" alt="Duyệt theo chiều rộng của một đồ thị" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div class="interactive-widget-wrapper" id="graph-bfs-steps-wrapper"><div class="slider-container"><div class="slide active"><img src="dsa-assets/graph_bfs_step1.png" alt="Bước 1: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 1: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step2.png" alt="Bước 2: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 2: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step3.png" alt="Bước 3: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 3: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step4.png" alt="Bước 4: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 4: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step5.png" alt="Bước 5: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 5: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step6.png" alt="Bước 6: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 6: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step7.png" alt="Bước 7: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 7: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step8.png" alt="Bước 8: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 8: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step9.png" alt="Bước 9: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 9: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step10.png" alt="Bước 10: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 10: Duyệt BFS</p></div><div class="slide"><img src="dsa-assets/graph_bfs_step11.png" alt="Bước 11: Duyệt BFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 11: Duyệt BFS</p></div><div class="slider-controls"><button class="slider-btn" onclick="prevSlide('graph-bfs-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 11</span><button class="slider-btn" onclick="nextSlide('graph-bfs-steps-wrapper')">Sau ▶</button></div></div></div>
...
<div style="text-align: center; margin: 1.5em 0;">
  <img src="dsa-assets/graph_dfs.png" alt="Duyệt theo chiều sâu của một đồ thị" style="max-width: 100%; height: auto; border-radius: var(--radius-md);" />
</div>
...
<div class="interactive-widget-wrapper" id="graph-dfs-steps-wrapper"><div class="slider-container"><div class="slide active"><img src="dsa-assets/graph_dfs_step1.png" alt="Bước 1: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 1: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step2.png" alt="Bước 2: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 2: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step3.png" alt="Bước 3: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 3: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step4.png" alt="Bước 4: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 4: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step5.png" alt="Bước 5: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 5: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step6.png" alt="Bước 6: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 6: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step7.png" alt="Bước 7: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 7: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step8.png" alt="Bước 8: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 8: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step9.png" alt="Bước 9: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 9: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step10.png" alt="Bước 10: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 10: Duyệt DFS</p></div><div class="slide"><img src="dsa-assets/graph_dfs_step11.png" alt="Bước 11: Duyệt DFS" style="max-width:100%; height:auto; border-radius: var(--radius-md);" /><p class="slide-caption">Bước 11: Duyệt DFS</p></div><div class="slider-controls"><button class="slider-btn" onclick="prevSlide('graph-dfs-steps-wrapper')">◀ Trước</button><span class="slider-indicator">Bước 1 / 11</span><button class="slider-btn" onclick="nextSlide('graph-dfs-steps-wrapper')">Sau ▶</button></div></div></div>
